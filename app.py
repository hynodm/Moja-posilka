...
# --- KONFIGURÁCIA (Tvoja posledná adresa) ---
...
with st.form("gym_form", clear_on_submit=True):
    ...
    if st.form_submit_button("Uložiť do tabuľky"):
        if cvik:
            try:
                # DÔLEŽITÉ: Názvy kat, cvik, vaha, opak musia sedieť s Apps Scriptom
                payload = {
                    "kat": kat,
                    "cvik": cvik,
                    "vaha": str(vaha),
...
try:
    ...
    st.info("⌛ História sa zobrazí po prvom správnom zápise.")
